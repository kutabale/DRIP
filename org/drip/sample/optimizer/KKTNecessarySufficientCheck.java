...
public class KKTNecessarySufficientCheck {
		...
		throws Exception
	{
		return new RdToR1 (null) {
			...
			@Override public double evaluate (
				...
				throws Exception
			{
				return dblDeadCenter + dblHalfWidth - adblVariate[iDimension];
			}
		...
		throws Exception
	{
		return new RdToR1 (null) {
			...
			@Override public double evaluate (
				...
				throws Exception
			{
				return adblVariate[iDimension] - dblDeadCenter + dblHalfWidth;
			}
		...
		throws Exception
	{
		...
		RdToR1[] aConstraintRdToR1 = new RdToR1[] {
			LeftConstraint (
				dblX0,
				0,
				dblHalfWidth
		...
		for (int i = 0; i < adblStartingVariate.length; ++i)
			System.out.println (vicm.variates()[i]);
	}
}
