...
/**
 * EfficientTradingTrajectory contains the Trading Trajectory generated by a given Optimal Trajectory
 *  Generation Scheme. Schemes may be Numerical or Closed Form. The References are:
 * 
...
public class EfficientTradingTrajectory extends org.drip.execution.strategy.TradingTrajectory {
	...
	/**
	 * Construct a Standard EfficientTradingTrajectory Instance
	 * 
	 ...
	 * 
	 * @return The EfficientTradingTrajectory Instance
	 */

	public static EfficientTradingTrajectory Standard (
		...
		final org.drip.execution.dynamics.ArithmeticPriceEvolutionParameters apep)
	{
		org.drip.execution.strategy.TradingTrajectory tt =
			org.drip.execution.strategy.TradingTrajectory.Standard (adblExecutionTimeNode, adblHoldings);
		...
		try {
			...
			return null == r1un ? null : new EfficientTradingTrajectory (adblExecutionTimeNode, adblHoldings,
				tt.tradeList(), r1un.mean(), r1un.variance());
	...
	/**
	 * EfficientTradingTrajectory Constructor
	 * 
	 * @param adblExecutionTimeNode Array containing the Trajectory Time Nodes
	 * @param adblHoldings Array containing the Holdings
	...
	public EfficientTradingTrajectory (
		final double[] adblExecutionTimeNode,
		final double[] adblHoldings,
		...
		throws java.lang.Exception
	{
		...
		if (!org.drip.quant.common.NumberUtil.IsValid (_dblTransactionCostExpectation =
			...
			throw new java.lang.Exception ("EfficientTradingTrajectory Constructor => Invalid Inputs");
	}
