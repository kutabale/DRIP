...
/**
 * HighUrgencyAsymptoteContinuous contains the High Urgency Asymptote of the Static Continuous Trading
...
public class HighUrgencyAsymptoteContinuous extends
	org.drip.execution.nonadaptive.StaticOptimalSchemeContinuous {

	/**
	 * Create the Standard HighUrgencyAsymptoteContinuous Instance
	 * 
	 ...
	 * 
	 * @return The HighUrgencyAsymptoteContinuous Instance
	 */

	public static final HighUrgencyAsymptoteContinuous Standard (
	...
	{
		try {
			return new HighUrgencyAsymptoteContinuous (new org.drip.execution.strategy.OrderSpecification
	...
	private HighUrgencyAsymptoteContinuous (
	...
	@Override public org.drip.execution.optimum.EfficientTradingTrajectory generate()
	{
				...
				throws java.lang.Exception
			{
				if (!org.drip.quant.common.NumberUtil.IsValid (dblTime))
					throw new java.lang.Exception
						("HighUrgencyAsymptoteContinuous::Holdings::evaluate => Invalid Inputs");
		...
		org.drip.function.definition.R1ToR1 r1ToR1TradeRate = new org.drip.function.definition.R1ToR1 (null)
		{
				...
				throws java.lang.Exception
			{
				if (!org.drip.quant.common.NumberUtil.IsValid (dblTime))
					throw new java.lang.Exception
						("HighUrgencyAsymptoteContinuous::TradeRate::evaluate => Invalid Inputs");
