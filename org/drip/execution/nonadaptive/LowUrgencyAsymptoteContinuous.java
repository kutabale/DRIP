...
/**
 * LowUrgencyAsymptoteContinuous contains the Low Urgency Asymptote of the Static Continuous Trading
...
public class LowUrgencyAsymptoteContinuous extends
	org.drip.execution.nonadaptive.StaticOptimalSchemeContinuous {

	/**
	 * Create the Standard LowUrgencyAsymptoteContinuous Instance
	 * 
	 ...
	 * 
	 * @return The LowUrgencyAsymptoteContinuous Instance
	 */

	public static final LowUrgencyAsymptoteContinuous Standard (
	...
	{
		try {
			return new LowUrgencyAsymptoteContinuous (new org.drip.execution.strategy.OrderSpecification
	...
	private LowUrgencyAsymptoteContinuous (
	...
	@Override public org.drip.execution.optimum.EfficientTradingTrajectory generate()
	{
				...
				throws java.lang.Exception
			{
				if (!org.drip.quant.common.NumberUtil.IsValid (dblTime))
					throw new java.lang.Exception
						("LowUrgencyAsymptoteContinuous::Holdings::evaluate => Invalid Inputs");
		...
		org.drip.function.definition.R1ToR1 r1ToR1TradeRate = new org.drip.function.definition.R1ToR1 (null)
		{
				...
				throws java.lang.Exception
			{
				if (!org.drip.quant.common.NumberUtil.IsValid (dblTime))
					throw new java.lang.Exception
						("LowUrgencyAsymptoteContinuous::TradeRate::evaluate => Invalid Inputs");
		...
		org.drip.function.definition.R1ToR1 r1ToR1TransactionCostExpectation = new
				...
				throws java.lang.Exception
			{
				if (!org.drip.quant.common.NumberUtil.IsValid (dblTime))
					throw new java.lang.Exception
						("LowUrgencyAsymptoteContinuous::TransactionCostExpectation::evaluate => Invalid Inputs");
