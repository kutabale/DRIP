...
public class VolumeTimeFrame extends org.drip.execution.evolution.GenericIncrement {
		...
		throws java.lang.Exception
	{
		...
		return _dblHoldings * brownian() + cv.invariant() * _dblTradeRate * _dblTradeRate * temporal();
	}
}
