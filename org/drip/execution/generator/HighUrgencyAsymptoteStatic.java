...
/**
 * HighUrgencyAsymptoteStatic contains the High Urgency Asymptote of the Static Continuous Trading Trajectory
...
public class HighUrgencyAsymptoteStatic extends org.drip.execution.generator.OptimalTrajectorySchemeContinuous
{

	/**
	 * Create the Standard HighUrgencyAsymptoteStatic Instance
	 * 
	...
	@Override public org.drip.execution.optimum.EfficientTradingTrajectory generate()
	{
				...
				throws java.lang.Exception
			{
				if (!org.drip.quant.common.NumberUtil.IsValid (dblTime))
					throw new java.lang.Exception
						("HighUrgencyAsymptoteStatic::Holdings::evaluate => Invalid Inputs");
		...
		org.drip.function.definition.R1ToR1 r1ToR1TradeRate = new org.drip.function.definition.R1ToR1 (null)
		{
				...
				throws java.lang.Exception
			{
				if (!org.drip.quant.common.NumberUtil.IsValid (dblTime))
					throw new java.lang.Exception
						("HighUrgencyAsymptoteStatic::TradeRate::evaluate => Invalid Inputs");
