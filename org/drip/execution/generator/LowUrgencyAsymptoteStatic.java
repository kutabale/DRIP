...
/**
 * LowUrgencyAsymptoteStatic contains the Low Urgency Asymptote of the Static Continuous Trading Trajectory
...
public class LowUrgencyAsymptoteStatic extends org.drip.execution.generator.OptimalTrajectorySchemeContinuous
{

	/**
	 * Create the Standard LowUrgencyAsymptoteStatic Instance
	 * 
	 ...
	 * 
	 * @return The LowUrgencyAsymptoteStatic Instance
	 */

	public static final LowUrgencyAsymptoteStatic Standard (
	...
	{
		try {
			return new LowUrgencyAsymptoteStatic (new org.drip.execution.strategy.OrderSpecification
	...
	private LowUrgencyAsymptoteStatic (
	...
	@Override public org.drip.execution.optimum.EfficientTradingTrajectory generate()
	{
				...
				throws java.lang.Exception
			{
				if (!org.drip.quant.common.NumberUtil.IsValid (dblTime))
					throw new java.lang.Exception
						("LowUrgencyAsymptoteStatic::Holdings::evaluate => Invalid Inputs");
		...
		org.drip.function.definition.R1ToR1 r1ToR1TradeRate = new org.drip.function.definition.R1ToR1 (null)
		{
				...
				throws java.lang.Exception
			{
				if (!org.drip.quant.common.NumberUtil.IsValid (dblTime))
					throw new java.lang.Exception
						("LowUrgencyAsymptoteStatic::TradeRate::evaluate => Invalid Inputs");
		...
		org.drip.function.definition.R1ToR1 r1ToR1TransactionCostExpectation = new
				...
				throws java.lang.Exception
			{
				if (!org.drip.quant.common.NumberUtil.IsValid (dblTime))
					throw new java.lang.Exception
						("LowUrgencyAsymptoteStatic::TransactionCostExpectation::evaluate => Invalid Inputs");
