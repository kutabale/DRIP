...
public class CollateralAmountEstimatorOutput {
	...
	{
		if (!org.drip.quant.common.NumberUtil.IsValid (_dblBankWindowMarginValue = dblBankWindowMarginValue)
			|| !org.drip.quant.common.NumberUtil.IsValid (_dblBankCollateralThreshold =
				dblBankCollateralThreshold) || !org.drip.quant.common.NumberUtil.IsValid
					(_dblBankPostingRequirement = dblBankPostingRequirement) ||
						!org.drip.quant.common.NumberUtil.IsValid (_dblCounterPartyWindowMarginValue =
							dblCounterPartyWindowMarginValue) || !org.drip.quant.common.NumberUtil.IsValid
								(_dblCounterPartyCollateralThreshold = dblCounterPartyCollateralThreshold) ||
									!org.drip.quant.common.NumberUtil.IsValid
										(_dblCounterPartyPostingRequirement =
											dblCounterPartyPostingRequirement) ||
												!org.drip.quant.common.NumberUtil.IsValid
													(_dblPostingRequirement = dblPostingRequirement))
