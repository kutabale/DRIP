...
public class LevelBurgardKjaerRun extends org.drip.xva.pde.LevelBurgardKjaer {
		...
		throws java.lang.Exception
	{
		...
		if (!org.drip.quant.common.NumberUtil.IsValid (_dblDerivativeFundingGrowth =
			dblDerivativeFundingGrowth) || !org.drip.quant.common.NumberUtil.IsValid
				(_dblDerivativeBankDefaultGrowth = dblDerivativeBankDefaultGrowth) ||
					!org.drip.quant.common.NumberUtil.IsValid (_dblDerivativeCounterPartyDefaultGrowth =
	...
	@Override public double gross()
	{
		return super.derivativeStochasticGrowth() + super.derivativeRiskFreeGrowth() +
			_dblDerivativeFundingGrowth + _dblDerivativeBankDefaultGrowth +
