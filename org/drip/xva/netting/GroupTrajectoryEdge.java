...
public class GroupTrajectoryEdge {
	...
	{
		if (null == (_gtvHead = gtvHead) || null == (_gtvTail = gtvTail))
	...
	/**
	 * Compute the Period Edge CVA
	 * 
	 * @return The Period Edge CVA
	 */
	...
	/**
	 * Compute the Period Edge DVA
	 * 
	 * @return The Period Edge DVA
	 */
