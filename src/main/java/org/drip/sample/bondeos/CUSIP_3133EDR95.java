...
public class CUSIP_3133EDR95 {
		...
		throws Exception
	{
		...
		double dblDiscountMarginTW = Double.NaN;
		...
		try {
			...
			dblDiscountMarginTW = bond.discountMarginFromYield (
				valParams,
				csqc,
				null,
				wi.date(),
		...
		System.out.println ("\t Bond Z Spread TW          => " + FormatUtil.FormatDouble (dblDiscountMarginTW, 1, 1, 10000.));
