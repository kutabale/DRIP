...
/**
 * MZ_YSW0U6 generates the Full Suite of Aladdin Replication Metrics for Bond YSW0U6.
 * 
...
public class MZ_YSW0U6 {
		...
		throws Exception
	{
		...
		AladdinBondReplicator abr = new AladdinBondReplicator (
			dblCleanPrice,
			dblIssuePrice,
			dblIssueAmount,
			dtSpot,
		...
		AladdinBondReplicationRun abrr = abr.generateRun();
