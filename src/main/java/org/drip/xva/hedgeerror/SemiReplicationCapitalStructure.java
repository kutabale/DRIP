...
/**
 * SemiReplicationCapitalStructure corresponds to the case of Hedge Error that results from the lack of
 *  Monetization of the potential Wind-fall upon the Bank's Default. The Evolution occurs under the Burgard
 *  Kjaer (2011, 2013) Methodology. This results in non-zero FCA. The References are:
 *  
...
public class SemiReplicationCapitalStructure extends org.drip.xva.pde.BurgardKjaerOperator {
	...
	{
		double dblCollateralizedFairValue = dblDerivativeFairValue - dblCollateral;

		return (1. - dblBankRecovery) * (dblCollateralizedFairValue > 0. ? dblCollateralizedFairValue : 0.);
	}

	/**
	 * SemiReplicationCapitalStructure Constructor
	 * 
